...
FAILED=0
IFS=";"
FILES="../include/dafka.h;../include/dafka_library.h;../include/dafka_proto.h;../include/dafka_publisher.h;../include/dafka_store.h;../include/dafka_subscriber.h;../src/dafka_classes.h;../src/dafka_private_selftest.c;../src/dafka_proto.c;../src/dafka_publisher.c;../src/dafka_selftest.c;../src/dafka_store.c;../src/dafka_stored.c;../src/dafka_subscriber.c"
IDS=$(echo -en "\n\b")
[ -n "$MAKE" ] || MAKE=make
for FILE in $FILES
do
